...
\castor{Which atoms are JavaScript specific? Semicolons. Destructuring of objects and arrays.}

\castor{Which atom candidates are atoms, considering these studies and the previous ones? Is a case where correctness exhibits no statistically significant difference but time does sufficient? The weight of experience. Statistical significance vs. practical relevance. Most of them, with the exception of Comma Operator and Object Destructuring, have also been observed for Java programs~\cite{Langhout:2021:ACJ}.
