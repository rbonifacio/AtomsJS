...
\item[+] There is no possibility of learning/practice effect because each participant is only exposed to one treatment. 
\item[+] Fatigue effect is reduced, since each participant is only exposed to code snippets related to one of the treatments. 
\end{itemize}}
\revised{
\noindent
...
\begin{itemize}
  ...
  \item[-] Potentially more variance between groups since each participant is only required to be exposed to one treatment. 
