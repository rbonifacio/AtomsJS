...
code snippets, from which five were in their confusing versions, whilst the other five contained cleaned versions of the
code snippets (i.e., without the confusing constructs and idioms). 
...
method (see the Odds Ratio column of Table~\ref{tab:hypothesis-testing}). We found a negligible effect size for the atom candidates Arithmetic as Logic, Logic as Control Flow, and
...
Ommitted Curly Braces & 48.85 & 30.00 & -38.58 \\ 
Assignment as Value & 52.47 & 48.95 & -6.71 \\ 
Implict Predicate & 36.24 & 24.01 & -33.75 \\ 
...
\end{table}
 ...
 \begin{table*}[ht]
\caption{Hipothesis Testing (misunderstanding and cognitive workload)}
\label{tab:hypothesis-testing}

 \centering
 \begin{tabular}{lcccc|cc}
   \toprule
Atom & ChiTest & Odds Ratio          & CI 2.5\% & CI 97.5\% & Wilcox Test & Cliff Delta \\ 
...
Ommitted Curly Braces & 0.050962 & 2.35 & 1.00 & 5.77 & 0.92529 & -0.01 \\ 
Assignment as Value & 0.0034775 & 8.39 & 1.81 & 79.12 & 0.82681 & 0.02 \\ 
Implict Predicate & 0.01123 & 6.95 & 1.46 & 66.56 & 0.0029039 & -0.29 \\ 
...
six atom candidates (Comma Operator, Automatic Semicolong Insertion,
Implicit Predicate, Logic
as Control Flow, Pre-Increment, and Arithmetic
as Logic). This result holds even after applying the Benjamini-Hochberg correction with a false discovery rate of 5\%. 
For the first four, the analysis suggests that the participants
...
Even for this atom candidate, some participants who preffered 
...
Similarly to previous studies~\cite{DBLP:conf/msr/GopsteinZFC18,DBLP:journals/ese/MedeirosLAAKRG19}, which investigte
...
occur in at least 80\% of the projects. Considering the extremes, atom Ternary Operator was found in all repositories we mined,
...
a total of {\color{red}\num{364873}} atoms of confusion, though three atoms are responsible for 87.97\% of this total: Ternary Operator, Omitted Curly Braces, and the Post Increment. The remaining atoms
...
(see Table~\ref{tab:difference-correctness}). As such, fixing the
the Post-Increment and Omitted Curly Braces might solve most
of the unclear code caused by atoms of confusion in
JavaScript projects. 
