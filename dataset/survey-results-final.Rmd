...
analysis_df <- data.frame(atomDescription, chiTest, oddsRatio, mannWhitneyTest, cliffDelta)
analysis_df <- analysis_df[order(-oddsRatio),]

colnames(analysis_df) <- c("Atom", "ChiTest", "Odds Ratio Correctness", "Wilcox Test (Time)", "Cliff Delta")
