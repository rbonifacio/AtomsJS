...
analysis_df <- data.frame(atomDescription, chiTest, oddsRatio, oddsRatioTest, ci25, ci975, mannWhitneyTest, cliffDelta)
analysis_df <- analysis_df[order(-oddsRatio),]
colnames(analysis_df) <- c("Atom", "ChiTest", "Odds Ratio Correctness", "p-value", "CI 2.5%", "CI 97.5%", "Wilcox Test (Time)", "Cliff Delta")
analysis_df
xtable(analysis_df)
```
